// Got this from flux labs (changes marked with MODIFIED)
var FluxDataSelector = (function() {

var sdk;
var dataTables = {};

var DataSelector = function DataSelector(clientId, redirectUri, config, isProd) {
...
DataSelector.prototype = {
    ...
    createKey: createKey,
    getKey: getKey,
    getDataTable: getDataTable,// MODIFIED
...
function init() {
    getSDK(this.clientId, this.redirectUri, this.isProd);
...
function getSDK(clientId, redirectUri, isProd) {
    if (!sdk) {
        var server = 'https://localhost:8443'; // MODIFIED
        if (isProd) {
            server = 'https://flux.io'; // PROD
        }
        var options = {
          fluxUrl: server,
          redirectUri: redirectUri
        };
        sdk = new FluxSdk(clientId, options);
    }
